...
!function () {
    ...
    w.prototype = [], w.prototype.constructor = w, T.extend = function () {
        ...
        return "limit" === e ? (c(o), i) : (l = l || r.value, "string" == typeof l && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(), i.endDate = i.endDate || i.systemDate(), r.dateTime = T.extend({}, i.startDate), T.each([i.startDate, i.endDate], function (e, t) {
            m(t, l[e], e)
        })) : m(o, l) : (i.hint("日期格式不合法<br>必须遵循下述格式：<br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>已为你重置"), a = !0) : "object" == typeof l ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime), c(o), a && l && i.setValue(r.range ? i.endDate ? i.parse() : "" : i.parse()), e && e(), i)
        ...
        t.elem[0] && !t.elem[0].eventHandler && (n(t.elem, "bind"), n(t.eventElem), T(document).on("click", function (n) {
            ...
            13 === t.keyCode && (t.preventDefault(), T("#" + e.elemID)[0] && e.elemID === D.thisElem && T(e.footer).find(p)[0].click())
...
layui.define("layer", function (e) {
    ...
    f.prototype.config = {
        ...
        t.elem.off("upload.start").on("upload.start", function () {
            ...
            e.upload()
        }), t.elem.data("haveEvents") || (t.elem.on("click", function () {
        ...
        var o = this, s = e.data, u = o.config, f = [], h = [], y = [], p = function () {
            return !c && o.sortKey ? o.sort(o.sortKey.field, o.sortKey.sort, !0) : (layui.each(s, function (e, a) {
                ...
                o.eachCols(function (c, o) {
                    var s = a[o.field || c];
                    if (void 0 !== s && null !== s || (s = 0 === c ? e + 1 : ""), !(o.colspan > 1)) {
